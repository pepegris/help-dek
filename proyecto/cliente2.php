...
error_reporting(0);
	...
	$registros=mysqli_query($con,"select * from cliente order by cedula ") or die("Problemas en el select:".mysqli_error($con));
	mysqli_close($con);
	$contador= 0;
...
<table align="center">
<tr><td> <a href="reporte1/reporte_pdf.php"><img src="images/pdf.png" width=80></a></td><td><a href="reporte1/reporte_word.php"><img src="images/word.png" width=80></a></td><td><a href="reporte1/reporte_excel.php"> <img src="images/excel.png" width=80></a></td></tr>
    ...
    <?php 
        ...
        ?>
            <tr align="center">
                ...
                <td><?php echo $datos["nac"]."-".$datos["cedula"];?></td>
